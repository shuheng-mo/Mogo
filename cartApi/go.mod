module github.com/acse-sm321/Mogo/cartApi

go 1.17

require (
	github.com/acse-sm321/Mogo/cart v0.0.0-20220802090403-e2b050fb0dd4
	github.com/acse-sm321/Mogo/common v0.0.0-20220802090403-e2b050fb0dd4
